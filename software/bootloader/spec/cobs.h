...
typedef enum { COBS_RET_SUCCESS = 0, COBS_RET_ERR_BAD_ARG, COBS_RET_ERR_BAD_PAYLOAD, COBS_RET_ERR_EXHAUSTED } cobs_ret_t;
...
cobs_ret_t cobs_decode_inc(cobs_decode_inc_ctx_t *ctx, cobs_decode_inc_args_t const *args,
