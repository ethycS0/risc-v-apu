...
ARCHITECTURE structural OF execution_unit IS
	...
	SIGNAL s_trap_val : STD_LOGIC_VECTOR(31 DOWNTO 0);
...
BEGIN
	...
	WITH s_trap_type SELECT
		s_trap_val <= x"00000000" WHEN TRAP_CALL,
		i_pc_id WHEN TRAP_BREAK,
		x"00000000" WHEN OTHERS;
	...
	PROCESS (s_trap_trigger, s_is_mret, s_mtvec_val, s_mepc_val, i_ex_op_type_id, s_pc_plus_imm, s_branch_taken, s_alu_result_raw, i_src_a_id)
	BEGIN
		o_pc_redirect <= '0';
