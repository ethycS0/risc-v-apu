...
\author{
\IEEEauthorblockN{1\textsuperscript{st} Arjun Salunkhe}
\IEEEauthorblockA{\textit{Student at} \\
\textit{Ajeenkya DY Patil School of Engineering}\\
Pune, India \\
arjun.salunkhe@proton.me}
\and
\IEEEauthorblockN{2\textsuperscript{nd} Atharva Bhosale}
\IEEEauthorblockA{\textit{Student at} \\
\textit{Ajeenkya DY Patil School of Engineering}\\
Pune, India \\
atharvagoldi@gmail.com}
\and
\IEEEauthorblockN{3\textsuperscript{rd} Srushti Shinde}
\IEEEauthorblockA{\textit{Student at} \\
\textit{Ajeenkya DY Patil School of Engineering}\\
Pune, India \\
srushtishinde0612@gmail.com}
\and
\IEEEauthorblockN{4\textsuperscript{th} Sourabh Bansode}
\IEEEauthorblockA{\textit{Student at} \\
\textit{Ajeenkya DY Patil School of Engineering}\\
Pune, India \\
souravsbansode@gmail.com}
\and
\IEEEauthorblockN{5\textsuperscript{th} Kanchan Vaidya}
\IEEEauthorblockA{\textit{Assistant Professor at} \\
\textit{Ajeenkya DY Patil School of Engineering}\\
Pune, India \\
...
\bibitem{b1} Rao, M., Niranjan, P., \& MJ, D. K. (2024, October). Design and Implementation of 32-bit RISC-V Processor Using Verilog. In \textit{2024 IEEE International Conference on Distributed Computing, VLSI, Electrical Circuits and Robotics (DISCOVER)} (pp. 181–186). IEEE.

\bibitem{b2} Tine, B., Elsabbagh, F., Yalamarthy, K., \& Kim, H. (2021). Vortex: Extending the RISC-V ISA for GPGPU and 3D-Graphics Research. In \textit{54th Annual IEEE/ACM International Symposium on Microarchitecture (MICRO)} (pp. 1–13). ACM.

\bibitem{b3} Machetti, S., Schiavone, P. D., Orlandic, L., Huang, D., Kasap, D., Ansaloni, G., \& Atienza, D. (2025). e-GPU: An Open-Source and Configurable RISC-V Graphic Processing Unit for TinyAI Applications. \textit{IEEE Transactions on Embedded Systems}.

\bibitem{b4} Goh, J. K., \& Uttraphan, C. (2024). An Enhanced UTHM RISC-V Processor Core Architecture Implemented on FPGA. \textit{Evolution in Electrical and Electronic Engineering}, 5(2), 32–41.

\bibitem{b5} Rodrigues, J. F. M. (2019). Configurable RISC-V Softcore Processor for FPGA Implementation (Master’s thesis, Instituto Superior Técnico).

\bibitem{b6} Li, Z., Hu, W., \& Chen, S. (2019, August). Design and Implementation of CNN Custom Processor Based on RISC-V Architecture. In \textit{2019 IEEE 21st International Conference on High Performance Computing and Communications (HPCC/SmartCity/DSS)} (pp. 1945–1950). IEEE.

\bibitem{b7} Begum, S., \& Kumar, T. (2023). FPGA-based Implementation of 32-bit RISC-V Processor. \textit{International Journal of Engineering Research and Technology}.

\bibitem{b8} Zhou, Y., Jin, X., \& Xiang, T. (2020). RISC-V Graphics Rendering Instruction Set Extensions for Embedded Chips. In \textit{Proceedings of the 2020 ACM Symposium on Embedded Computing}. ACM.

\bibitem{b9} Matthews, E. et al. (2021). Soft-Processor Parameterized RISC-V. \textit{IEEE Transactions on Computers}.

\bibitem{b10} Pol, L. (2021). Lightweight Open-Source RISC-V Processor for IoT. In \textit{Mobility, Sensing, and Networking Conference}.

\bibitem{b11} Miyazaki, H., Kanamori, T., Islam, M. A., \& Kise, K. (2020). RVCoreP: An Optimized RISC-V Soft Processor of Five-Stage Pipelining. \textit{IEICE Transactions on Information and Systems}, 103(12), 2494–2503.

\bibitem{b12} Barriga, A. et al. (2021). Synthesis and Verification of RISC-V Cores. In \textit{International Symposium on Embedded Systems}.

\bibitem{b13} Jo, S. et al. (2023). Single Cycle RISC-V Core Implementation. \textit{International Journal of Engineering Research and Technology}.

\bibitem{b14} Jinyu, J. et al. (2022). Implementing RISC-V ISA on FPGA. \textit{International Journal of Advanced Engineering}.

\bibitem{b15} Bhatia, N., D’Souza, M., \& Chakrabarti, S. K. (2019, February). Formalizing GPU Instruction Set Architecture in Coq. In \textit{Proceedings of the 12th Innovations in Software Engineering Conference} (pp. 1–5).

\bibitem{b16} Elsabbagh, F., Tine, B., Roshan, P., Lyons, E., Kim, E., Shim, D. E., ... \& Lim, S. K. (2020). Vortex: OpenCL Compatible RISC-V GPGPU. \textit{arXiv preprint arXiv:2002.12151}.

\bibitem{b17} Al Kadi, M., Janssen, B., \& Huebner, M. (2016, February). FGPU: An SIMT Architecture for FPGAs. In \textit{Proceedings of the 2016 ACM/SIGDA International Symposium on Field-Programmable Gate Arrays} (pp. 254–263).

\bibitem{b18} OpenHW Group. (2019). Open Bus Interface (OBI) Specification. Retrieved from \url{https://openhwgroup.org/specifications/}

\bibitem{b19} Vortex GPGPU. (n.d.). GitHub Repository. Retrieved from \url{https://github.com/vortexgpgpu/vortex}

\bibitem{b20} Smol GPU. (n.d.). GitHub Repository. Retrieved from \url{https://github.com/Grubre/smol-gpu}

\bibitem{b21} RISCY. (n.d.). GitHub Repository. Retrieved from \url{https://github.com/mongrelgem/RISCY}

\bibitem{b22} RISC-V Foundation. (2019). \textit{The RISC-V Instruction Set Manual, Volume I: Unprivileged ISA, Version 2.1 (RV32I/64I/128I)}. Retrieved from \url{https://riscv.org/technical/specifications/}
