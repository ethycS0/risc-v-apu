...
\abstract{This paper reviews recent research and development efforts on Field Programmable Gate Array (FPGA)
based implementations of Reduced Instruction Set Computing version Five (RISC-V) Accelerated Processing
Units (APUs) that integrate CPU and GPU capabilities on a unified platform. Focused primarily on RV32I
processors extended with SIMD/SIMT architectures and GPU-specialized accelerators, this work examines
open-source Hardware Description Language (HDL) implementations targeting resource-efficient computing.
Key topics include architectural design, programmability, and co-design challenges.
Architectures such as Vortex and e-GPU serve as case studies illustrating state-of-the-art RISC-V GPU design
strategies combined with RV32I base CPU to design a RISC-V Heterogeneous Computing Unit.}
